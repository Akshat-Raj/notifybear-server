# Generated by Django 4.2.16 on 2026-01-14 14:51
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "text_lines",
                    models.TextField(
                        blank=True, help_text="JSON array of text lines", null=True
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "snoozed_until",
                    models.DateTimeField(
                        blank=True, help_text="For future snooze feature", null=True
                    ),
                ),
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["user", "is_read", "ml_score"],
                        name="Notificatio_user_id_a86e29_idx",
                    ),
                    models.Index(
                        fields=["user", "opened_at"],
                        name="Notificatio_user_id_5f8320_idx",
                    ),
                    models.Index(
                        fields=["notification_event", "user"],
                        name="Notificatio_notific_6891ff_idx",
                    ),
                ],
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["notification_event", "message_time"],
                        name="Notificatio_notific_a572f2_idx",
                    )
                ],
            },
        ),
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["app", "post_time"], name="Notificatio_app_id_f2640e_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="notificationevent",
            index=models.Index(
                fields=["app", "notif_key"], name="Notificatio_app_id_277e3b_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="notificationevent",
            index=models.Index(
                fields=["post_time"], name="Notificatio_post_ti_b5b41f_idx"
            ),
        ),
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["user", "timestamp"], name="Notificatio_user_id_cdf040_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="interactionevent",
            index=models.Index(
                fields=["notification_event", "timestamp"],
                name="Notificatio_notific_3f6c71_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="interactionevent",
            index=models.Index(
                ...
                name="Notificatio_user_id_e09856_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="dailyaggregate",
            index=models.Index(
                fields=["user", "day"], name="Notificatio_user_id_9d3b70_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="dailyaggregate",
            index=models.Index(
                fields=["app", "day"], name="Notificatio_app_id_5bb072_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="dailyaggregate",
        ...
        migrations.AddIndex(
            model_name="app",
            index=models.Index(
                fields=["user", "package_name"], name="Notificatio_user_id_c02e2d_idx"
            ),
        ),
        migrations.AlterUniqueTogether(
            name="app",
